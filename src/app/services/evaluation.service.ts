...
export class EvaluationService {
  ...
  private submissionsUrl = `${this.BASE_URL}/submissions`;
  ...
  // Submissions
  getAllSubmissions(): Observable<SubmissionResult[]> {
    return this.http.get<SubmissionResult[]>(this.submissionsUrl);
  }

  getSubmissionsByUser(userId: string): Observable<SubmissionResult[]> {
    return this.http.get<SubmissionResult[]>(`${this.submissionsUrl}/user/${userId}`);
  }
